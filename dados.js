...
const LEGENDA = {
  ...
  '74': { local: 'Penicilina', setor: 'Penicilina' },
  '75': { local: 'Penicilina', setor: 'Penicilina' },
  '76': { local: 'Penicilina', setor: 'Penicilina' },
  '77': { local: 'Penicilina', setor: 'Penicilina' },
  ...
  'Pens.': { local: 'Penicilina', setor: 'Penicilina' }
};
